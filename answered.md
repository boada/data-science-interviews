...
LDA models are evaluated via a measure called perplexity, which is a standard measure of performance for statistical models  of  natural  language. Perplexity measures the uncertainty in predicting a single word; lower values are better, and chance performance results in a perplexity equal to the size of the vocabulary. 
